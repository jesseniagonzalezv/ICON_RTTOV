...
# module load python3
# conda activate phd
# path_dataset=/work/bb1036/b381362/dataset #/home/jvillarreal /home/jvillarreal/Documents/phd/dataset #/
# path_output=$HOME/output   #$HOME/Documents/phd/output #/poorgafile1/climate
...
# python random-forest.py --path-ICON $path_dataset/data_rttov_T12_dropupbottom_Reff.nc --path-output $path_output/output_RF --rttov-path-refl-emmis $path_output/output-rttov/rttov-131-data-icon-1to19-26-T12.nc --rttov-path-rad $path_output/output-rttov/rttov-13-data-icon-1-to-36-not-flip.nc &> log_rf.txt
