...
python PCA_radiances.py --path-in '/home/jvillarreal/Documents/phd/github/output-rttov/' --name-input 'rttov-131-data-icon-1-3-4-T12.nc' --path-out '/home/jvillarreal/Documents/phd/output' &> log_PCA.txt
